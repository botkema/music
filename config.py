...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/botkema/music",
)
...
CHANNEL_NAME = getenv("CHANNEL_NAME"," تحديثات  كيم")
CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/KIM_TF")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/KIM_TF")
